...
export { ClientOptions } from 'dimona-usa-api';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/dimona-usa-api',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the dimona-usa-api MCP server. You will use Code Mode to help the user perform
