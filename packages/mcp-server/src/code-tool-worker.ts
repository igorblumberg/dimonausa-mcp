...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: DimonaUsaAPI)`
    : `const run: (${functionSource.client}: DimonaUsaAPI) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    'client.v2021.getInventory',
    'client.v2021.stock.list',
    'client.v2021.stock.retrieve',
    'client.v2021.shipping.calculateRates',
    'client.v2021.orders.cancel',
    'client.v2021.orders.create',
    'client.v2021.orders.retrieve',
    'client.v2021.orders.retrieveEvents',
    'client.v3.submitOrder',
    'client.analytics.retrieveDailyOperations',
    'client.analytics.retrieveProductionSummary',
    'client.analytics.retrieveSKUImpactAnalysis',
    'client.analytics.retrieveWeeklySummary',
    'client.analytics.productionSnapshot.retrieveByCreationDate',
    'client.analytics.productionSnapshot.retrieveByShipDate',
    'client.analytics.lateness.retrieveExecutiveSummary',
    'client.analytics.reports.createItemStatusReport',
    'client.analytics.reports.createOrdersPerCustomer',
    'client.analytics.reports.getItemsSoldRanking',
    'client.analysis.analyze',
    'client.analysis.listTypes',
